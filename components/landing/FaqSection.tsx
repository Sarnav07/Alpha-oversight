...
const FAQS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Yes. Every handoff and verdict is hash-chained into a replayable ledger, so any edit breaks the chain and is caught instantly.",
  },
  {
    q: "Who is the desk for?",
    a: "Trade-surveillance desks, compliance teams, and exchanges that need to catch novel market-abuse tactics before they cause damage.",
  },
  {
