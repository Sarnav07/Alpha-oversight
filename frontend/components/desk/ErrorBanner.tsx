 ...
 * band-blue (that is reserved for "waiting on Band"). Slides in under reduced
        ...
        >
          <div
            ...
            style={{
              ...
              borderBottom: "1px solid var(--verdict-flag)",
              boxShadow: "inset 3px 0 0 0 var(--verdict-flag)",
            }}
          >
            <span
              aria-hidden
              className="inline-block w-[7px] h-[7px] rounded-full shrink-0"
              style={{ background: "var(--verdict-flag)" }}
            />
            <span style={{ color: "var(--verdict-flag)", fontWeight: 600 }}>
              Backend unreachable
            </span>
