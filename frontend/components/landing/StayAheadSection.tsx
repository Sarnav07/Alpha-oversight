  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Stay ahead of market abuse
          <br />
          with{" "}
          <span style={{ color: "var(--text-faint)" }}>Alpha &amp; Oversight</span>
        </motion.h2>
        ...
        >
          Bring the desk online and let the Band contest every trade. Alpha &amp; Oversight is how
          surveillance stays one step ahead of the adversary.
        </motion.p>
